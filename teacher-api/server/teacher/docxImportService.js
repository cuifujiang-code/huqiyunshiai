/**
 * DOCX 教辅书导入（teacher-api 自包含版）
 * 所有依赖导入均指向 teacher-api 内部文件，不跨出目录
 */
...
export { cleanBookChapters, buildCleanSummaryMessage } from './bookDocxClean.js'
...
/** 将内嵌 base64 图片提取为 figures 数组，正文替换为短占位符 */
